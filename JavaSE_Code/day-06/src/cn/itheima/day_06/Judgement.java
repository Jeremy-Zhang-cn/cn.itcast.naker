...
public class Judgement {
	...
	public static void autoInitArray(int[] arr) {    //自动初始化数组
	...
	//返回值类型为void, 参数类型为int[] arr
	public static void manuallyInitArray(int[] arr) {    //手动初始化数组
	...
	//返回值类型为int, 参数类型为int[] arr
	public static int getMin(int[] arr) {    //获取数组中的最小值
	...
	public static int getAvg(int[] arr) {
		...
		int sum = 0;
		for (int i = 0; i < arr.length; i++) {    //数组求和
			sum += arr[i];
		}
	...
	//返回值类型为void, 参数类型为int[] arr
	public static void printArray(int[] arr) {    //格式化输出数组内容
